...
const convertMapData = (data, geoCoordMap) => {
  let res = [];
 ...
 * @returns
 */
export const convertAirlineSeries = (datas = [], colors, geoCoordMap) => {
  let series = [];
    ...
    series.push(
      {
        ...
        data: convertMapData(item[1], geoCoordMap),
      },
      {
        name: item[0] + ' Top3',
        type: 'lines',
...
export const getGeoMapOption = (series) => {
  let option = {
    tooltip: {
      trigger: 'item',
