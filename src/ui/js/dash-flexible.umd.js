...
(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined'
    ...
    : ((global =
      ...
      factory((global.DashFlexible = {})));
})(this, function (exports) {
  'use strict';

  function flexibleOn(window, document) {
    // 返回文档的root元素
  ...
  function flexibleOff(window, document) {
    // 返回文档的root元素
    const docEl = document.documentElement;
  ...
  exports.flexibleOff = flexibleOff;
  exports.flexibleOn = flexibleOn;
